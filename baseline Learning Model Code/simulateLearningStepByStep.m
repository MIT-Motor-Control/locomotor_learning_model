function pInputControllerStore_OnesTried = simulateLearningStepByStep(paramFixed, ...
...
%     end
    ...
    EdotNow = EdotNow*(1+randn*paramFixed.noiseEnergySensory);
    ...
    contextNow = contextNow + paramFixed.noiseEnergySensory*randn;
